        ...
        <Reveal delay={0.05}>
          <div className="space-y-6">
            ...
            <div className="space-y-5 text-base leading-relaxed text-muted-foreground">
              <p>
                I am a Computer Science and Artificial Intelligence engineering student with
                hands-on experience in full-stack development, artificial intelligence, data
                analytics, APIs, databases, cloud deployment and software projects.
              </p>
              <p>
                My development background helps me understand how applications are built,
                while my interest in software quality drives me to think about how
                applications can fail, how defects can be identified, and how reliable
                software can be delivered.
              </p>
              <p>
                I am currently targeting roles across software engineering, quality
                assurance and AI/ML — including Associate Software Tester / QA positions
                where I can contribute to functional testing, API testing, test case design,
                defect identification, regression testing and automation.
              </p>
            </div>
          </div>
        </Reveal>
